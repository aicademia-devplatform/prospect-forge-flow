              ...
              <div className="flex-1 overflow-auto" ref={tableContainerRef}>
                <table className="w-full min-w-max">
                  ...
                  <thead className="sticky top-0 bg-table-header border-b border-table-border z-20">
                    <tr>
                      <th className="w-12 px-4 py-4 text-left sticky top-0 left-0 bg-blue-50/95 backdrop-blur-sm border-r border-blue-200/30 z-30 font-inter font-medium">
                        ...
                        return (
                          <th 
                            ...
                            className={`
                              ...
                              sticky top-0 
                              ${isPinned ? 'left-0 z-30 bg-blue-50/95 backdrop-blur-sm border-r border-blue-200/30 font-inter font-medium' : 'z-20 bg-table-header'}
                            `}
                  ...
                  return <tr key={rowId} className={`border-b border-table-border hover:bg-table-row-hover transition-colors ${isSelected ? 'bg-table-selected' : ''}`}>
                          <td className="w-12 px-4 py-4 sticky left-0 bg-blue-50/95 backdrop-blur-sm border-r border-blue-200/30 z-10 font-inter font-medium">
                          ...
                          {displayColumns.map(column => {
                            ...
                            return (
                              <td 
                                key={column.name} 
                                className={`px-4 py-4 min-w-[120px] ${isPinned ? 'sticky bg-blue-50/95 backdrop-blur-sm border-r border-blue-200/30 z-10 font-inter font-medium' : ''}`}
                                style={isPinned ? { left: '48px' } : {}}
                              >
