    ...
    Tables: {
      ...
      hubspot_contacts: {
        Row: {
          ...
          createdate_ms: number | null
          email: string
          firstname: string | null
          hs_all_owner_ids: string | null
          hs_analytics_first_timestamp: string | null
          hs_analytics_first_timestamp_ms: number | null
          hs_analytics_num_event_completions: number | null
          hs_analytics_num_page_views: number | null
          hs_analytics_num_visits: number | null
          hs_analytics_revenue: number | null
          hs_calculated_phone_number: string | null
          hs_calculated_phone_number_country_code: string | null
          hs_count_is_unworked: number | null
          hs_count_is_worked: number | null
          hs_email_domain: string | null
          hs_first_engagement_object_id: number | null
          hs_first_outreach_date: string | null
          hs_first_outreach_date_ms: number | null
          hs_is_contact: boolean | null
          hs_is_unworked: boolean | null
          hs_latest_source: string | null
          hs_latest_source_timestamp: string | null
          hs_latest_source_timestamp_ms: number | null
          hs_lead_status: string | null
          hs_membership_has_accessed_private_content: boolean | null
          hs_messaging_engagement_score: number | null
          ...
          hs_registered_member: boolean | null
          hs_sa_first_engagement_date_ms: number | null
          hs_sa_first_engagement_descr: string | null
          hs_sa_first_engagement_object_type: string | null
          hs_searchable_calculated_phone_number: string | null
          hs_time_to_first_engagement: number | null
          hs_user_ids_of_all_owners: string | null
          hubspot_owner_archived: boolean | null
          hubspot_owner_assigneddate: string | null
          hubspot_owner_assigneddate_ms: number | null
          hubspot_owner_created_at: string | null
          hubspot_owner_email: string | null
          hubspot_owner_firstname: string | null
          hubspot_owner_id: number | null
          hubspot_owner_lastname: string | null
          hubspot_owner_raw: Json | null
          hubspot_owner_type: string | null
          hubspot_owner_updated_at: string | null
          id: number
          identity_profiles_raw: Json | null
          identity_saved_at: string | null
          identity_saved_at_ms: number | null
          inserted_at: string | null
          jobtitle: string | null
          lastmodifieddate: string | null
          lastmodifieddate_ms: number | null
          lastname: string | null
          lead_guid: string | null
          lifecyclestage: string | null
          linkedin_account: string | null
          notes_last_contacted: string | null
          notes_last_contacted_ms: number | null
          notes_last_updated: string | null
          notes_last_updated_ms: number | null
          notes_next_activity_date: string | null
          notes_next_activity_date_ms: number | null
          num_contacted_notes: number | null
          num_conversion_events: number | null
          num_notes: number | null
          num_unique_conversion_events: number | null
          phone: string | null
          portal_id: number | null
          primary_email: string | null
          properties_raw: Json | null
          state: string | null
          updated_at: string | null
          vid: number | null
        }
