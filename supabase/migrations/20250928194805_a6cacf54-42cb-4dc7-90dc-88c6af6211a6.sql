...
-- This addresses the SUPA_security_definer_view and MISSING_RLS_PROTECTION findings

-- Drop existing views first
DROP VIEW IF EXISTS public.v_apollo_contacts_only CASCADE;
DROP VIEW IF EXISTS public.v_contacts_crm_apollo CASCADE;

-- Create a security invoker function to replace v_apollo_contacts_only view
-- This ensures the function runs with the permissions of the calling user, not the function owner
...
-- Create a security invoker function to replace v_contacts_crm_apollo view
